package com.unity.models.jdbc.daos;
...
import com.unity.models.player.Enemy;
import com.unity.models.player.Friend;
import com.unity.models.player.Fusion;
...
import com.unitu.models.server.AntiLogin;
                    ...
                    if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
                        ...
                        if (!rs.first()) {
                            ...
                            if (player.rankSieuHang == 999999) {
                                player.rankSieuHang = (int) ServerManager.gI().getNumPlayer();
                            }
    ...
    public static void checkVang(int x) {
     ...
     public static Player loadByIdSieuHang(int id) {
        ...
        try {
            ...
            if (rs.first()) {
                long plHp = 2123456789;
                long plMp = 2123456789;
                JSONValue jv = new JSONValue();
                JSONArray dataArray = null;
