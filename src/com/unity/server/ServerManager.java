...
import com.unity.models.map.daihoi.DaiHoiService;
import com.unity.models.map.sieuhang.SieuHangManager;
...
//        new Thread(TopService.gI(), "Thread TOP").start();
        ...
        try {
            ...
            Manager.MAPS.forEach(com.unity.models.map.Map::initBoss);
