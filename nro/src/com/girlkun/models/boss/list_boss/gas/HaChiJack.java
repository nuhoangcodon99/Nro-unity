...
public class HaChiJack extends Boss {
  ...
  private long lastTimeHapThu;
   ...
   public void reward(Player plKill) {
            if ( levell < 2000){
                      ItemMap it = new ItemMap(this.zone, 14, (levell/4), this.location.x, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
            Service.getInstance().dropItemMap(this.zone, it);               
                    ItemMap it1 = new ItemMap(this.zone, 15, (levell/10), this.location.x, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
            Service.getInstance().dropItemMap(this.zone, it1);
            
            ItemMap it2 = new ItemMap(this.zone, 16, (levell/20), this.location.x, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
            ...
            ItemMap it3 = new ItemMap(this.zone, 15, (levell/400), this.location.x, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
            Service.getInstance().dropItemMap(this.zone, it3);
                    ItemMap it1 = new ItemMap(this.zone, 16, (levell/10), this.location.x, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
            Service.getInstance().dropItemMap(this.zone, it1);
            
            ItemMap it2 = new ItemMap(this.zone, 17, (levell/20), this.location.x, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
            Service.getInstance().dropItemMap(this.zone, it2);
        }
        ...
        if (Util.isTrue(100, 100)) {
            ItemMap caitrangmi = new ItemMap(this.zone, 729, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
            this.location.y - 24), plKill.id);
            caitrangmi.options.add(new Item.ItemOption(50, 50));
            caitrangmi.options.add(new Item.ItemOption(77, 32));
            caitrangmi.options.add(new Item.ItemOption(117, 20));
            caitrangmi.options.add(new Item.ItemOption(5, 80));
