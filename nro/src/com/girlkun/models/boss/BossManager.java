...
import com.girlkun.models.boss.list_boss.BLACK.thegioi;
import com.girlkun.models.boss.list_boss.BLACK.goku;
import com.girlkun.models.boss.list_boss.BLACK.vegeta;
import com.girlkun.models.boss.list_boss.BLACK.thanvip;
import com.girlkun.models.boss.list_boss.Boss.MaBuCom;
import com.girlkun.models.map.MapMaBu.MapMaBu2h;
import com.girlkun.models.map.mabu_2h.BuBung;
import com.girlkun.models.mapTruongMyLan.bossmylan;
import com.girlkun.models.boss.list_boss.Boss.MaBuDepTrai;
import com.girlkun.models.boss.list_boss.Boss.MaBuMap;
import com.girlkun.models.boss.list_boss.Boss.cuuvy;
...
import com.girlkun.models.map.mabu_2h.MapXHMaBu2h;
import com.girlkun.models.map.mabu_2h.BuMap;
    ...
    public void loadBoss() {
        ...
        try {
           ...
           this.createBoss(BossID.BOSS_KHI_ULTRA); 
            ...
            this.createBoss(BossID.THEGIOI);
            this.createBoss(BossID.THEGIOI);
            this.createBoss(BossID.THEGIOI);
            this.createBoss(BossID.THEGIOI);
            ...
            this.createBoss(BossID.BU_MAP);
            this.createBoss(BossID.ZAMASMAX);
            this.createBoss(BossID.BU_MAP);
            this.createBoss(BossID.CUUVY);
            this.createBoss(BossID.CUUVY);
            this.createBoss(BossID.BU_MAP);
            this.createBoss(BossID.BU_MAP);
            this.createBoss(BossID.BU_MAP);
            ...
            this.createBoss(BossID.BU_MAP);
            this.createBoss(BossID.BU_MAP);
            this.createBoss(BossID.BU_BUNG);
            this.createBoss(BossID.VEGETA4);
            this.createBoss(BossID.VEGETA4);
            this.createBoss(BossID.VEGETA4);
            ...
            this.createBoss(BossID.THANVIP);
            this.createBoss(BossID.THANVIP);
            this.createBoss(BossID.THANVIP);
            this.createBoss(BossID.THANVIP);
            this.createBoss(BossID.THANVIP);
