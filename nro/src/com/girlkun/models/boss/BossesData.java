...
//**************************************************************************
    ...
    //*************
    public static final BossData THEGIOI = new BossData(
            "BOSS Thế Giới",
            ConstPlayer.XAYDA,
            new short[]{1495, 1496, 1497, -1, -1, -1},
            10000,
            new long[]{300000000000L},
            new int[]{170},
            new int[][]{
    ...
    public static final BossData GOKU4 = new BossData(
            "GOKU SSJ 4",
            ConstPlayer.XAYDA,
            new short[]{1333, 1334, 1335, -1, -1, -1},
            100000,
    ...
    public static final BossData MYLAN = new BossData(
            "TRƯƠNG MỸ LAN'S",
            ConstPlayer.XAYDA,
            new short[]{1555, 1556, 1557, -1, -1, -1},
            1000,
            new long[]{100000000000L},
            new int[]{179},
            new int[][]{
                {Skill.LIEN_HOAN, 7, 10},
    ...
    public static final BossData BU_MAP_2H = new BossData(
            ...
            60000,
            new long[]{200000000000L},
            new int[]{127},
            new int[][]{
                {Skill.DEMON, 3, 1000}, {Skill.DEMON, 6, 2000}, {Skill.DRAGON, 7, 3000}, {Skill.DRAGON, 1, 4000}, {Skill.GALICK, 5, 5000},
                {Skill.KAMEJOKO, 7, 6000}, {Skill.KAMEJOKO, 6, 4000}, {Skill.KAMEJOKO, 5, 4000}, {Skill.KAMEJOKO, 4, 4000}, {Skill.KAMEJOKO, 3, 4000}, {Skill.KAMEJOKO, 2, 1100}, {Skill.KAMEJOKO, 1, 1200},
                {Skill.ANTOMIC, 1, 1300}, {Skill.ANTOMIC, 2, 1400}, {Skill.ANTOMIC, 3, 1500}, {Skill.ANTOMIC, 4, 1600}, {Skill.ANTOMIC, 5, 1700}, {Skill.ANTOMIC, 6, 1900}, {Skill.ANTOMIC, 7, 2000},
    ...
    public static final BossData BU_BUNG = new BossData(
            ...
            new int[]{128},
            new int[][]{
                {Skill.DRAGON, 7, 3000}, {Skill.KAMEJOKO, 7, 5000},
    ...
    public static final BossData VEGETA4 = new BossData(
            "VEGETA SSJ 4",
            ConstPlayer.XAYDA,
            new short[]{1339, 1340, 1341, -1, -1, -1},
            100000,
            new long[]{50000000000L},
            new int[]{5},
            new int[][]{
    ...
    public static final BossData THANVIP = new BossData(
            "THÀN THIÊN SỨ",
            ConstPlayer.XAYDA,
            new short[]{505, 506, 507, -1, -1, -1},
            500000,
            new long[]{500000000000L},
            new int[]{5},
            new int[][]{
    ...
    public static final BossData CUUVY = new BossData(
            "Cữu Vỹ",
            ConstPlayer.XAYDA,
            new short[]{1456, 1457, 1458, -1, -1, -1},
            100000,
            new long[]{500000000000L},
            new int[]{170},
            new int[][]{
    ...
    public static final BossData SIEU_BO_HUNG_2 = new BossData(
            ...
            new int[][]{
                ...
                {Skill.DICH_CHUYEN_TUC_THOI, 7, 100000},
                {Skill.THAI_DUONG_HA_SAN, 7, 1500000},
                {Skill.LIEN_HOAN, 7, 10000}},//skill
            new String[]{"|-1|Cuối cùng thì ngươi cũng đến Goku,... ta đang đợi ngươi đây...",
                "|-1|Chào mừng đến với giải đấu!!!",
                "|-2|Vậy thì... Chúng ta bắt đầu cuộc chiến thôi chứ! Tớ lên trước nhé!",
