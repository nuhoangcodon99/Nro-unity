...
public class NPoint {
    ...
    private void setHpMax() {
        ...
        //set nappa
        if (this.player.setClothes.SAO9 == 5) {
            this.hpMax += ((long) this.hpMax * 10 / 100);
            this.mpMax += ((long) this.hpMax * 10 / 100);
            this.dame += ((long) this.hpMax * 10 / 100);
        }
        //set worldcup
        ...
        if (this.player.itemTime != null && this.player.itemTime.isUseBoHuyet3) {
            this.hpMax *= 2;
        }
        if (this.player.itemTime != null && this.player.itemTime.isUsetnsmvip) {
  ...
  //              this.tlDameCrit.add(5);
    ...
    private void setMpMax() {
        ...
        if (this.player.itemTime != null && this.player.itemTime.isUseBoKhi3) {
            this.mpMax *= 2;
        }
...
//        }
    ...
    private void setDame() {
       ...
       if (this.player.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
        ...
        if (this.player.itemTime != null && this.player.itemTime.isUseCuongNo3) {
            this.dame *= 1.5;
        }
        //giảm dame
...
//        }
    ...
    public long calSucManhTiemNang(long tiemNang) {
        if (power < getPowerLimit()) {
            ...
            if (this.player.setClothes.TNSM == 5) {
                tiemNang += ((long) tiemNang * 15);
            }
            if (this.intrinsic != null && this.intrinsic.id == 24) {
                tiemNang += ((long) tiemNang * this.intrinsic.param1 / 100);
            }
            if (this.power >= 60000000000L) {
                tiemNang -= ((long) tiemNang * 94 / 100);
            }
