...
public class Inventory {
    ...
    public static final long LIMIT_GOLD = 90000_0000_000_000_000L; // Giới hạn vàng
    
    public static final int LIMIT_RUBY = 2_000_000_000; // Giới hạn Ruby
    
    public static final int CAN_TRADE = 2_000_000_000; 

    public static final int MAX_ITEMS_BAG = 110;
    public static final int MAX_ITEMS_BOX = 110;
