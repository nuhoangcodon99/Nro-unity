                ...
                default:
                    switch (item.template.id) {
                        ...
                        case 1120:
                            ...
                            break;
                        case 1557:
                            Openhopzamas(pl, item);
                            break;
                        case 1558:
                            Openhoppetvip(pl, item);
                            break;
                        case 1559:
                            Openhopvanbay(pl, item);
                            break;
                        case 1560:
                            Openhopdeolung(pl, item);
                            break;
                        case 1572:
                            Settnsm(pl, item);
                            break;
...
//                listClothesReward = new int[]{randClothes(param), randClothes(param)};
    ...
    private void Settnsm(Player pl, Item it) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 5) {
            int gender = pl.gender;
            int[] id = {gender, 6 + gender, 21 + gender, 27 + gender, 12, 194};
            ...
            for (int i = 0; i < arrLength; i++) {
                if (i < 5) {
                    ...
                    item.itemOptions.add(new ItemOption(234, 1));
            ...
            InventoryServiceNew.gI().subQuantityItemsBag(pl, it, 1);
            InventoryServiceNew.gI().sendItemBags(pl);
    ...
    private void Settusat(Player pl, Item it) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 5) {
            int gender = pl.gender;
            int[] id = {gender, 6 + gender, 21 + gender, 27 + gender, 12, 194};
            int[] soluong = {1, 1, 1, 1, 1, 1, 10, 10, 10, 10, 10, 10, 10};
            ...
            for (int i = 0; i < arrLength; i++) {
                if (i < 5) {
                    Item item = ItemService.gI().createNewItem((short) id[i]);
                    RewardService.gI().initBaseOptionClothes(item.template.id, item.template.type, item.itemOptions);
                    item.itemOptions.add(new ItemOption(236, 1));
                    item.itemOptions.add(new ItemOption(237, 1));
                    InventoryServiceNew.gI().addItemBag(pl, item);
                } else {
                    Item item = ItemService.gI().createNewItem((short) id[i]);
                    item.quantity = soluong[i];
    ...
    private void tlxd1(Player pl, Item it) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 5) {
            int gender = pl.gender;
            int[] id = {gender, 562 + gender, 555 + gender, 556 + gender, 563 + gender, 561, 194};
            int[] soluong = {1,1, 1, 1, 1, 1, 10, 10, 10, 10, 10, 10, 10};
            int[] option = {0, 0, 0, 0, 0, 73, 95, 96, 97, 98, 99, 100, 101};
            int[] param = {0, 0, 0, 0, 0, 0, 5, 5, 5, 3, 3, 5, 5};
            int arrLength = id.length - 1;
    ...
    private void tlxd2(Player pl, Item it) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 5) {
            int gender = pl.gender;
            int[] id = {gender, 557 + gender, 558 + gender, 564 + gender, 565 + gender, 561, 194};
            int[] soluong = {1,1, 1, 1, 1, 1, 10, 10, 10, 10, 10, 10, 10};
            int[] option = {0, 0, 0, 0, 0, 73, 95, 96, 97, 98, 99, 100, 101};
            int[] param = {0, 0, 0, 0, 0, 0, 5, 5, 5, 3, 3, 5, 5};
            int arrLength = id.length - 1;
    ...
    private void tlxd3(Player pl, Item it) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 5) {
            int gender = pl.gender;
            int[] id = {gender, 559 + gender, 560 + gender, 561 + gender, 567 + gender, 566, 194};
            int[] soluong = {1,1, 1, 1, 1, 1, 10, 10, 10, 10, 10, 10, 10};
            int[] option = {0, 0, 0, 0, 0, 73, 95, 96, 97, 98, 99, 100, 101};
            int[] param = {0, 0, 0, 0, 0, 0, 5, 5, 5, 3, 3, 5, 5};
            int arrLength = id.length - 1;
    ...
    private void Openhopzamas(Player pl, Item item) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 0) {
            boolean vinhvien = Manager.TotalCaiTrang >= 100;
            int[] rdct = new int[]{1490};
           // int[] rdop = new int[]{16};
         ...
         //   int randomop = new Random().nextInt(rdop.length);
            ...
            if (!vinhvien) {
                ct.itemOptions.add(new Item.ItemOption(50, Util.nextInt(40, 50)));
                ct.itemOptions.add(new Item.ItemOption(77, Util.nextInt(40, 50)));
                ct.itemOptions.add(new Item.ItemOption(103, Util.nextInt(40, 50)));
                ct.itemOptions.add(new Item.ItemOption(93, Util.nextInt(1, 2)));
    ...
    private void Openhopvanbay(Player pl, Item item) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 0) {
            boolean vinhvien = Manager.TotalCaiTrang >= 100;
            int[] rdct = new int[]{1337, 1338, 1339};
           // int[] rdop = new int[]{16};
            int randomct = new Random().nextInt(rdct.length);
         //   int randomop = new Random().nextInt(rdop.length);
            Item ct = ItemService.gI().createNewItem((short) rdct[randomct]);
            ...
            if (!vinhvien) {
                ...
                ct.itemOptions.add(new Item.ItemOption(50, Util.nextInt(4, 10)));
                ct.itemOptions.add(new Item.ItemOption(77, Util.nextInt(4, 10)));
                ct.itemOptions.add(new Item.ItemOption(103, Util.nextInt(4, 10)));
                Manager.TotalCaiTrang = 0;
            }
            InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
            InventoryServiceNew.gI().addItemBag(pl, ct);
    ...
    private void Openhopdeolung(Player pl, Item item) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 0) {
            boolean vinhvien = Manager.TotalCaiTrang >= 150;
            int[] rdct = new int[]{1525};
           // int[] rdop = new int[]{16};
            int randomct = new Random().nextInt(rdct.length);
         //   int randomop = new Random().nextInt(rdop.length);
            Item ct = ItemService.gI().createNewItem((short) rdct[randomct]);
            ...
            if (!vinhvien) {
                ct.itemOptions.add(new Item.ItemOption(50, Util.nextInt(5, 10)));
                ct.itemOptions.add(new Item.ItemOption(77, Util.nextInt(6, 10)));
                ct.itemOptions.add(new Item.ItemOption(103, Util.nextInt(6, 10)));
                ct.itemOptions.add(new Item.ItemOption(93, Util.nextInt(1, 2)));
                Manager.TotalCaiTrang += 1;
            } else {
                ct.itemOptions.add(new Item.ItemOption(50, Util.nextInt(4, 10)));
                ct.itemOptions.add(new Item.ItemOption(77, Util.nextInt(4, 10)));
                ct.itemOptions.add(new Item.ItemOption(103, Util.nextInt(4, 10)));
                ct.itemOptions.add(new Item.ItemOption(5, Util.nextInt(10, 20)));
                Manager.TotalCaiTrang = 0;
            }
            InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
            InventoryServiceNew.gI().addItemBag(pl, ct);
    ...
    private void Openhoppetvip(Player pl, Item item) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 0) {
            boolean vinhvien = Manager.TotalCaiTrang >= 100;
            int[] rdct = new int[]{1487, 1488};
           // int[] rdop = new int[]{16};
            int randomct = new Random().nextInt(rdct.length);
         //   int randomop = new Random().nextInt(rdop.length);
            Item ct = ItemService.gI().createNewItem((short) rdct[randomct]);
    ...
    private void useItemTime(Player pl, Item item) {
        switch (item.template.id) {
            case 382: //bổ huyết
                ...
                break;
            case 1568: //bổ huyết
                pl.itemTime.lastTimetnsmvip = System.currentTimeMillis();
                pl.itemTime.isUsetnsmvip = true;
                break;
            case 383: //bổ khí
            ...
            case 2037: //máy dò đồ
                ...
                break;
            case 1565: //cuồng nộ
                pl.itemTime.lastTimeCuongNo3 = System.currentTimeMillis();
                pl.itemTime.isUseCuongNo3 = true;
                Service.gI().point(pl);
                break;
            case 1567: //bổ huyết
                pl.itemTime.lastTimeBoHuyet3 = System.currentTimeMillis();
                pl.itemTime.isUseBoHuyet3 = true;
                break;
            case 1566: //bổ khí
                pl.itemTime.lastTimeBoKhi3 = System.currentTimeMillis();
                pl.itemTime.isUseBoKhi3 = true;
                break;
...
//                    Service.gI().sendThongBao(pl, "NONOOO");
    ...
    public void choseMapCapsule(Player pl, int index) {
        ...
        if (zoneChose.getNumOfPlayers() > 25
                ...
                || MapService.gI().isMapMaBu2h(zoneChose.map.mapId)) {
