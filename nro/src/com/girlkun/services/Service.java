    ...
    public void chat(Player player, String text) {
        ...
        if (player.getSession() != null && player.isAdmin()) {
            ...
            if (text.equals("client")) {
             ...
             } else if (text.equals("in4") || text.equals("tt") || text.equals("thongtin")) {
            NpcService.gI().createMenuConMeo(player, ConstNpc.INFO, 12639,"|7|- •⊹٭DragonBall UNITY٭⊹• -\n"
            ...
            if (text.equals("admin")) {
                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_ADMIN, 348, "|7| ADMIN \n •⊹٭Ngọc Rồng UNITY٭⊹•\b|2| •⊹٭♥vantanz♥٭⊹•\b|4| Người Đang Chơi: " + Client.gI().getPlayers().size() + "\n" + "|8|Current thread: " + (Thread.activeCount() - ServerManager.gI().threadMap)
...
//        }
        ...
        if (text.equals("player")) {
            NpcService.gI().createMenuConMeo(player, ConstNpc.CLCK, 348, "|7|Dragon Ball UNITY\n" + "\n"
                    + "|1|ACCOUNT SERVICE" + "\n" + "Chào bạn : " + player.name + " | ID: (" + player.id + ") | " + "Map : " + player.zone.map.mapName + "\n"
    ...
    public void player(Player pl) {
        ...
        try {
            ...
            msg.writer().writeShort(348); //char info id
...
//            Send_Info_NV(pl);
    ...
    public void sendThongBaoFromAdmin(Player player, String text) {
        sendBigMessage(player, 348, text);
    }
...
//            e.printStackTrace();
    ...
    public void attackPlayer(Player pl, long idPlAnPem) {
