...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.isUseBoHuyet3) {
            sendItemTime(player, 16005, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeBoHuyet3)) / 1000));
        }
        if (player.itemTime.isUseBoKhi3) {
            sendItemTime(player, 15076, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeBoKhi3)) / 1000));
        }
        ...
        if (player.itemTime.isUseCuongNo3) {
            sendItemTime(player, 22446, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeCuongNo3)) / 1000));
        }
        if (player.itemTime.isUsetnsmvip) {
            sendItemTime(player, 21880, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimetnsmvip)) / 1000));
        }
