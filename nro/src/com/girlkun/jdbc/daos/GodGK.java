...
//                    Service.gI().sendThongBaoOK(session, "Tài khoản đang được đăng nhập tại máy chủ khác");
                    ...
                    if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
                        ...
                        if (!rs.first()) {
                            ...
                            player.itemTime.lastTimeBoHuyet3 = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timeBoHuyet);
                            player.itemTime.lastTimeBoKhi3 = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timeBoKhi);
                            ...
                            player.itemTime.lastTimeCuongNo3 = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timeCuongNo);
                            player.itemTime.lastTimetnsmvip = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timeCuongNo);
