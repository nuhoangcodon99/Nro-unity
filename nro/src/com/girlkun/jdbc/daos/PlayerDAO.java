    ...
    public static void updatePlayer(Player player) {
        if (player.iDMark.isLoadedAllDataPlayer()) {
            ...
            try {
                ...
                dataArray.add((player.itemTime.isUseBoHuyet3 ? (ItemTime.TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeBoHuyet3)) : 0));
                dataArray.add((player.itemTime.isUseBoKhi3 ? (ItemTime.TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeBoKhi3)) : 0));
                ...
                dataArray.add((player.itemTime.isUseCuongNo3 ? (ItemTime.TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeCuongNo3)) : 0));
                          dataArray.add((player.itemTime.isUsetnsmvip ? (ItemTime.TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimetnsmvip)) : 0));
                ...
                GirlkunDB.executeUpdate(query,
                        ...
                        player.thachdauwhis,
                        player.id);
             //   Logger.success("Save data player " + player.name + " thành công time = " + (System.currentTimeMillis() - st) + "\n");
            } catch (Exception e) {
