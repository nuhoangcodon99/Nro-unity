...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_MAP_11h = "Ta đã làm mất số tiền vào tay kẻ xấu"
            + " Đối Tượng Mỹ Lan đã chiếm đoạt tài sản và trốn ra biển "
            + "hắn chỉ xuất hiện vào lúc 11h hàng ngày!!";
    public static final String HUONG_DAN_MAP_MYLAN = "XEM CON CẶC "
            + "vào lúc 11h"
            + " hàng ngày hãy giải cứu 44 tỷ đô";
    ...
    public static final byte NANGCAP = 99;
    public static final byte SUKIEN = 100;
    ...
    public static final byte LANVIP1 = 101;
    ...
    public static final byte SONTINK = 98;
    ...
    public static final int DAPSKH1 = 50296;
    ...
    public static final int INFO = 192000;
    ...
    //index menu truong my lan
    public static final int MENU_NOT_OPEN_MMB1 = 500;
    public static final int MENU_OPEN_MMB1 = 501;
    public static final int MENU_REWARD_MMB1 = 502;
