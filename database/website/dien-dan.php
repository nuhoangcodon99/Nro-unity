        ...
        <div class="row">
            <div class="col">
                <div class="box-stt">
                    ...
                    <div class="box-right">
                        <a href="mo-thanh-vien" class="important"> Mở Thành Viên 20k <img src="image/hot.gif"></a>
                ...
                <div class="box-stt">
                    ...
                    <div class="box-right">
                        ...
                        <div class="box-name" style="font-size: 9px;"> Bởi Vantanz </div>
                    </div>
                </div>
                <div class="box-stt">
                    <div style="width: 40px; float:left; margin-right: 5px;">
                            ...
                            if ($row['admin'] == 1) {
                                ...
                                switch ($row['theloai']) {
                                    case 0:
                                        ...
                                        break;
                                    case 1:
                                        $titleColor = 'color: #006400; font-weight: bold;'; // Green color
                                        break;
                                    case 2:
                                        $titleColor = 'color: #A52A2A; font-weight: bold;'; // Orange color
                                        break;
                                    case 3:
                                        $titleColor = 'color: #EF2020; font-weight: bold;'; // Red color
                                        break;
                                    default:
                            ...
                            if (mysqli_num_rows($result2) > 0) {
                                while ($row2 = mysqli_fetch_assoc($result2)) {
                                    ...
                                    if ($row2['admin'] == 1 && !$thao_luan_da_hien_thi) {
                                        echo '<span class="text-info"> (Admin Đã Tham Gia)</span>';
                ...
                <div class="col">
                    <div class="text-center">
                        <div style="font-size: 13px" class="text-dark">
                            ...
                            <small>2024© Ngọc Rồng New 01</small>
                        </div>
                    </div>
                </div>
            </div>
