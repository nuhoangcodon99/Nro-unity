                                    ...
                                    <div style="font-size: 9px; padding-top: 5px">
                                        ...
                                        if (isset($_GET['id'])) {
                                            ...
                                            if ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo '<br>';
                                                echo '<span style="white-space: pre-wrap;">' . $row['noidung'] . '</span><br>';
                                                ...
                                                if (is_array($image_filenames) && !empty($image_filenames)) {
                                                    foreach ($image_filenames as $image_filename) {
                                                        ...
                                                        if (file_exists($image_path)) {
                                                            echo '<img src="' . $image_path . '" alt="Ảnh" style="max-width: 100%; height: auto;"><br><br>';
                                                        } else {
                                ...
                                <tr>
                                    <td width="60px;" style="vertical-align: top">
                                        <div class="text-center" style="margin-left: -10px;">
                                            <div style="font-size: 9px; padding-top: 5px">
                                                <?php
                                                // display the user avatar and tichdiem
                                                $gender = intval($comment['gender']);
                                                switch ($gender) {
                                                    case 1:
                                                        $avatar_url = "image/avatar1.png";
                                                        break;
                                    ...
                                    <div class="text-left" style="display: block;">
                                        ...
                                        if ($row = mysqli_fetch_assoc($result)) {
                                            if ($row['trangthai'] == 0):
                                                ...
                                                $sql = "SELECT player.name, player.gender FROM player INNER JOIN account ON account.id = player.account_id WHERE account.username='$_username'";
                                                $result = mysqli_query($conn, $sql);
                                                $row = mysqli_fetch_assoc($result);
                                                ...
                                                if ($row2['admin'] == 1) {
                                                    ...
                                                    if (isset($_SESSION['id'])) {
                                                        ...
                                                        if ($admin_row['admin'] == 1) {
                                                            ?>
                                                            <form method="POST">
                                                                <button class="btn btn-main btn-sm" id="btn-delete" name="delete_post"
                                                                    type="submit">Xoá Bài</button>
                                                                <button class="btn btn-main btn-sm" id="btn-pin" name="pin_post"
                                                                ...
                                                                <button class="btn btn-main btn-sm" id="btn-block-comments"
                                                                    name="block_comments" type="submit">Khoá Bình Luận</button>
                                                                <button class="btn btn-main btn-sm" id="btn-unlock-comments"
                                            ...
                                            <script>
                                                ...
                                                form.addEventListener('submit', (event) => {
                                                    ...
                                                    if (traloi < 5) {
                                                        ...
                                                        submitError.innerHTML = '<strong>Lỗi:</strong> Bình luận phải có ít nhất 5 ký tự!'; submitError.style.display = 'block'; submitBtn.scrollIntoView({ behavior: 'smooth', block: 'start' });
                                                    }
                                                });
