...
$_title = "Ngọc Rồng New 01 - Đăng Nhập";
if ($_login == null) {
...
<head>
    ...
    <title>Trang Chủ Chính Thức - Ngọc Rồng New</title>
            ...
            <div class="row bg pb-3 pt-2">
                <div class="col">
                    ...
                    <div class="text-center pt-2">
                        <div style="display: inline-block;"> <a href="../download/Nro Alockns.apk"> <img class="icon-download"
                                    src="image/android.png"></a> <br>
                            <small class="text-dark">0.0.1</small>
                        </div>
                        <div style="display: inline-block;"> <a href="../download/Mod Vũ Đăng V225.rar"><img class="icon-download"
                                    src="image/pc.png"></a> <br> <small class="text-dark">0.0.1</small> </div>
                        <div style="display: inline-block;"> <a href="../download/Nro Alockns.ipa"><img class="icon-download"
                ...
                <div class="col">
                    <div class="text-center">
                        <div style="font-size: 13px" class="text-dark">
                                    ...
                                    <small>2023© Ngọc Rồng New 01</small>
                                </div>
                            </div>
                    </div>
                </div>
