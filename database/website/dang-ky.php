            ...
            <div class="row bg pb-3 pt-2">
                <div class="col">
                    ...
                    <div class="text-center pt-2">
                        <div style="display: inline-block;"> <a href="../download/Nro Alockns.apk"> <img
                                    class="icon-download" src="image/android.png"></a> <br>
                            <small class="text-dark">2.1.4</small>
                        </div>
                        <div style="display: inline-block;"> <a href="../download/Mod Vũ Đăng V225.rar"><img
                                    class="icon-download" src="image/pc.png"></a> <br> <small
                                class="text-dark">2.2.5</small> </div>
                        <div style="display: inline-block;"> <a href="../download/Nro Alockns.ipa"><img
                                    class="icon-download" src="image/ip.png"></a> <br> <small
                                class="text-dark">2.2.5</small> </div>
